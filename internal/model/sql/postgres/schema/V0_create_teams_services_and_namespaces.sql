...
insert into person (email, slack_member_id, created_at) values ('daniel.dias@wildlifestudios.com', 'U01G0MW62LT', now());
insert into person (email, slack_member_id, created_at) values ('leo.haddad1@gmail.com', 'U01G06MMRFV', now());
insert into person (email, slack_member_id, created_at) values ('leonardo.haddad@wildlifestudios.com', 'U01G06MMRFV', now());
insert into person (email, slack_member_id, created_at) values ('matheus.nogueira@wildlifestudios.com', 'U01GD4SMZBK', now());
